...
<body>
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
     ...
     $conn = new mysqli("localhost","root","", "user_database");
      ...
      $sql = "SELECT Name FROM management_details WHERE Password = '$currentPassword'";
      ...
      if ($result->num_rows > 0) {
          ...
          $updateSql = "UPDATE management_details SET Password ='$newPassword'  WHERE Name ='$studentId'";
  ...
  ?>
  <p><a href="management_homepage.php">Go back to homepage</a></p>
</body>
</html>
