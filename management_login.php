...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['reset_password'])) {
        ...
        $sql = "UPDATE management_details SET Password='$username' WHERE Name='$username'";
        ...
        $sql = "SELECT * FROM management_details WHERE Name='$username' AND Password='$password'";
        ...
        if ($result->num_rows > 0) {
            ...
            header("Location: management_homepage.php?username=" . urlencode($username));
            exit();
        } else {
            // Display error message for incorrect cdentials
