...
<body>
  ...
  <h4>Management Resolution</h4>
  <br><br>
  <a href="change-password_management.php" class="button">Change Password</a>
  <a href="management_noticeboard.php" class="button">View Noticeboard</a>
  <a href="status_complaint_management.php" class="button">Assigned Complaints</a>
  <a href="logout_management.php" class="button">Logout</a>
</body>
</html>
