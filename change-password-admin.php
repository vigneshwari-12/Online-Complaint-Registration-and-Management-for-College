...
<body>
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
     ...
     $conn = new mysqli("localhost","root","", "user_database");
      ...
      $sql = "SELECT Name FROM admin_details WHERE Password = '$currentPassword'";
      ...
      if ($result->num_rows > 0) {
          ...
          $updateSql = "UPDATE admin_details SET Password ='$newPassword'  WHERE Name ='$studentId'";
  ...
  ?>
  <p><a href="admin_home_page.php">Go back to homepage</a></p>
</body>
</html>
